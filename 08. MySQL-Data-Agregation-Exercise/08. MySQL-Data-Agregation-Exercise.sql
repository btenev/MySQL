...
WHERE `department_id` IN(2,5,7) AND `hire_date` > '2001/01/01'
...
WHERE department_id = 1 AND salary > 30000;
...
FROM employees AS emp
WHERE  salary > (SELECT avg(salary) FROM employees AS emp1 WHERE emp1.department_id = emp.department_id)
